...
df = pd.read_csv("/Users/lifushen/Desktop/1d_cnn/clean_altogther-DualChainRotationEncodingBL62.csv", sep=',')
print(df.columns)
...
df_2.to_csv("data_clean_cluster_neg.csv", sep=',', index=False)
print(len(df_2))
