...
input_file = "/Users/lifushen/Desktop/1d_cnn/VDJ_test_2.csv"
data = pd.read_csv(input_file, sep=',', header=0)

# Check if all necessary columns are present
expected_columns = ['CDR3b', 'CDR3a', 'peptide','MHC','binder']
...
data['encoded_CDR3b'] = data['CDR3b'].apply(lambda s: EncodingCDR3(s, M6, n0))
data['encoded_CDR3a'] = data['CDR3a'].apply(lambda s: EncodingCDR3(s, M6, n0))

# Integer encode the remaining categorical fields
for column in ['peptide']:
...
new_column_order = ['encoded_CDR3a', 'encoded_CDR3b', 'peptide', 'MHC', 'binder']
...
output_file = "/Users/lifushen/Desktop/1d_cnn/output_encoded_2.csv"
