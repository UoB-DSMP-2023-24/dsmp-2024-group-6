...
data['encoded_CDR3a'] = data['cdr3_a_aa'].apply(lambda s: EncodingCDR3(s, M6, n0))
data['encoded_CDR3b'] = data['cdr3_b_aa'].apply(lambda s: EncodingCDR3(s, M6, n0))

# 重新排序列
new_column_order = ['cdr3_a_aa', 'encoded_CDR3a', 'cdr3_b_aa', 'encoded_CDR3b', 'antigen.epitope']

# 移除名为Unnamed的第一列，并按新的顺序重排其它列
...
# 保存到新的CSV文件
output_file = "/Users/lifushen/Desktop/giana_distance_matrix_visual/output_encoded_a_b.csv"
