...
# 步骤1: 加载数据
sparse_matrix = pd.read_csv('/Users/lifushen/Desktop/giana_distance_matrix_visual/distance_matrix_b.txt', sep='\t', index_col=0)
cdr3_to_epitope = pd.read_csv('/Users/lifushen/Desktop/giana_distance_matrix_visual/map_b.csv')

# 步骤2: 提取CDR3序列
cdr3_sequences = sparse_matrix.index

# 步骤3: 映射抗原表位
epitope_map = dict(zip(cdr3_to_epitope['cdr3_b_aa'], cdr3_to_epitope['antigen.epitope']))
...
plt.title('2-D visualization of CDR3 beta 4 (top 5 epitopes) using distance matrix')
plt.show()
