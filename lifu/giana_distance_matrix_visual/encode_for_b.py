...
# 检查所有必要的列是否存在
expected_columns = ['cdr3_b_aa', 'antigen.epitope']
...
# 重新排序列
new_column_order = ['cdr3_b_aa', 'encoded_CDR3b', 'antigen.epitope']
...
# 保存到新的CSV文件
output_file = "/Users/lifushen/Desktop/giana_distance_matrix_visual/output_encoded_b.csv"
