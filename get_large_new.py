...
df_unique = df_alpha_beta.drop_duplicates(subset=['cdr3_b_aa', 'cdr3_a_aa', 'antigen.epitope'])

# df_alpha_beta.to_csv("data_clean_small.csv", sep='\t', index=False)
df_alpha_beta.to_csv("data_clean_large_new.csv", sep='\t', index=False)
df_unique.to_csv("data_clean_large_new_unique.csv", sep='\t', index=False)
