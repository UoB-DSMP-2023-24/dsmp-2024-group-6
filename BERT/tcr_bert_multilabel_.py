...
df_alpha_beta = pd.read_csv("/Users/berlin/Documents/UoB/DSMP/pycharm_project_DSMP/dsmp-2024-group-6/data_clean_large.csv", index_col=0, sep='\t')
...
aggregated_df['encoded_epitopes'] = mlb.fit_transform(aggregated_df['encoded_epitopes'])
