...
# df_alpha_beta = df_alpha_beta[df_alpha_beta['antigen.epitope'] == 'GPRLGVRAT']
...
for epitope in unique_epitopes:
    ...
    # 初始化模型、优化器和损失函数
    model = tcr_bert_TwoPartBertClassifier_3.TwoPartBertClassifier(pretrained='/home/rnd/wmj/berlin/ttc/tcr-bert-mlm-only',
    ...
    # 训练模型
    train_model(model, train_loader, test_loader, optimizer, loss_fn, device, epochs=1, early_stopping_patience=10)
